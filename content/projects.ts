...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pipeline: [
      ...
      'Stored and normalised — URL detection, type classification',
    ...
    roadmap: [
      { stage: 'Now', text: 'Captures notes, summarises, extracts actions, and builds research briefs from Telegram or the CLI.' },
  ...
  },
  {
    ...
    stack: ['Financial modelling', 'Workflow design', 'Instructional design for a skeptical audience'],
    pullQuote: {
